        ...
        with tempfile.NamedTemporaryFile(mode='w', delete=True) as tmpfile:
            ...
            if result.returncode == 0:
                try:
                    ...
                    cmd = ["/home/michael/projects/code/build/lingodb-release/mlir-to-json", tmpfile.name,"/home/michael/projects/code/resources/data/" + db]
...
def run_sql_query(query_str, db):
    ...
    try:
        # Build command string
        cmd = ["/home/michael/projects/code/build/lingodb-release/run-sql", query_file, "/home/michael/projects/code/resources/data/"+db]
